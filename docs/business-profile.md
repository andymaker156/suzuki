...
## Business Card Source Details

- Rose-Marie Blanc: Piano Teacher, Suzuki Method.
- Jean (John) Blanc: Violin Teacher, Suzuki Method.
- The Suzuki message on the cards: "A method as a new concept in teaching a small child (3 years old or less) to play an instrument."
- Both teachers list membership in SAO, SAA, and ISA.
- Rose-Marie is listed as Musical Director of the Beethoven Society for Pianists.
- Jean is listed as Chairman of the Beethoven Society for Pianists.
- The card identifies the organization as `Beethoven Society for Pianists, Greater Toronto Chapter`.
- Historical card registration number: `0981704-22`.
...
- Rose-Marie is known as the Music Director and Founder of the BAPS Suzuki Program.
- Rose-Marie has a Diploma in Music from the University of Bucharest.
- Rose-Marie is a faculty member of Suzuki Kingston Musicfest.
...
- Allison Leyton-Brown official bio, noting Rose-Marie Blanc as her classical piano teacher for 17 years: https://www.allisonleytonbrown.com/wp-content/uploads/2016/06/Bio-Website-2016.pdf
- Sheet Music Plus listing for `Lumiere Solitaire`, noting a dedication to Rose-Marie Blanc and Jean Blanc: https://www.sheetmusicplus.com/en/product/lumiere-solitaire-romantic-piano-solo-by-allison-leyton-brown-20106236.html

## Best Audience

The best-fit audience is parents in Thornhill, Richmond Hill, Markham, North York, and the Greater Toronto Area who are comparing serious music education options for young children.

Priority customer segments:

- Parents of children age 3-8 starting music for the first time.
- Families with siblings where one child may study piano and another violin.
...
1. Suzuki piano and Suzuki violin under one roof.
2. A husband-and-wife teaching team with more than 30 years devoted to teaching and performing.
3. A strong fit for very young beginners, including children age 3 or under.
4. Recognized association credibility: SAO, SAA, ISA, Royal Conservatory affiliation.
5. Beethoven Society for Pianists founding and leadership.
...
- `/violin-lessons-thornhill.html`
- `/piano-lessons-thornhill.html`
- `/suzuki-method.html`
- `/rcm-preparation.html`
- `/faq.html`
...
- Suzuki violin lessons Thornhill
- Suzuki piano lessons Thornhill
- violin teacher Thornhill
- piano teacher Thornhill
- Suzuki music lessons Richmond Hill
- RCM violin teacher Thornhill
...
- "BAPS Suzuki Program"
- "Beverley Acres"
- "Thornhill and the Greater Toronto Area"

Avoid unless a direct testimonial says it:
...
- Whether "BAPS" should be written out in full for public audiences unfamiliar with the acronym.
